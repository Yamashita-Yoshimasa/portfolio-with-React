      ...
      <div className="p-about__wrap">
        ...
        <div className="p-about__container">
          ...
          <div className="p-about__box">
            ...
            <p className="p-about__text">
              私の一番やりたい事は人の役に立つ事です。それを考えた時思いついたのがWeb開発でした。なぜWeb開発なのかと言うと、Web開発はスピード感を持って多くの人に便利で役に立つものを届けることができると思ったからです。そして、そこから独学でWeb開発の学習をはじめました。HTML/CSSから勉強をはじめ、今ではReactでWebページ作成、GAEでデプロイ、Web上に公開までできるようになりました。基礎的な事はできるようになったと思い、本格的に転職を考えこのポートフォリオサイトを作成しました。以下の作品欄に私が作成したものを載せていますのでご覧頂ければ幸いです。また、Qiitaには私が勉強したこと、GitHubには私が書いたプログラムを載せています。そちらもよろしくお願いします。
            </p>
          </div>
        </div>
      </div>
